...
//import de style.scss
import './Dashboard/style.scss';
function Sidebar({ cour, note, examen }) {
  return (
    <div>
      <div className="sidebar">
        ...
        <ul className="sidebar-list">
          ...
          <li
            ...
            onClick={() => cour(true) || note(false) || examen(false)}
          >
            <a href="#">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li
            ...
            onClick={() => cour(false) || note(false) || examen(true)}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
          ...
          <li
            className="sidebar-list-item"
            onClick={() => cour(false) || note(true) || examen(false)}
          >
            <a href="#">
              <svg
                xmlns="http://www.w3.org/2000/svg"
